...

{
...

	{
...

        {
            ...
            $News->title_en = $this->input->post("title_en");
            $News->title_th = $this->input->post("title_th");
            $News->short_description_en = $this->input->post("short_description_en");
            $News->short_description_th = $this->input->post("short_description_th");
            $News->description_en = $this->input->post("description_en");
            $News->description_th = $this->input->post("description_th");
