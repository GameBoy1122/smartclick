...
class Administrator_group_permission_key_model extends CI_Model
{
    /** ========================================================================================= **
     **           SETTING
     ** ========================================================================================= **/
    ...
    private $table_name = "administrator_group_permission_key";
    private $table_primary_key = "administrator_group_permission_key_id";
    ...
    function getIdKey()
    {
        $administrator_group_permission_keys = $this->search();

        $response = array();
        foreach($administrator_group_permission_keys as $administrator_group_permission_key)
        {
            $response[$administrator_group_permission_key->administrator_group_permission_key_id] = $administrator_group_permission_key->key;
        }
