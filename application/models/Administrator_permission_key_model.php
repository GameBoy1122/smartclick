...
class Administrator_permission_key_model extends CI_Model
{
    /** ========================================================================================= **
     **           SETTING
     ** ========================================================================================= **/
    ...
    private $table_name = "administrator_permission_key";
    private $table_primary_key = "administrator_permission_key_id";
    ...
    function getIdKey()
    {
        $administrator_permission_keys = $this->search();

        $response = array();
        foreach($administrator_permission_keys as $administrator_permission_key)
        {
            $response[$administrator_permission_key->administrator_permission_key_id] = $administrator_permission_key->key;
        }
