                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="kt-radio-inline">
                                                        ...
                                                        <label class="kt-radio kt-radio--bold kt-radio--success">
                                                            ...
                                                            <input type="radio" name="status" value="ACTIVATE" <?php if (!isset($bannermain->status) || $bannermain->status == "ACTIVATE") echo "checked" ?>> Activate
                                                        ...
                                                        <label class="kt-radio kt-radio--bold kt-radio--warning">
                                                            ...
                                                            <input type="radio" name="status" value="SUSPEND" <?php if (isset($bannermain->status) && $bannermain->status != "ACTIVATE") echo "checked" ?>> Suspend
                                                    ...
                                                    <div class="kt-wizard-v3__form">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar1">
                                                                        ...
                                                                        if (isset($bannermain->image) && $bannermain->image != "" && file_exists(FCPATH . $bannermain->image)) {

                                                                            $image = base_url($bannermain->image);
                                                                        }

                                                                        ?>

                                                                        <div class="kt-avatar__holder" <?php if (isset($bannermain->image)) echo ' style="background-image:url(' . $image . ');"'; ?>> </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6 col-xl-7">
                                                                ...
                                                                <input type="text" class="form-control" name="title" value="<?php if (isset($bannermain->title)) echo $bannermain->title ?>">
                                                        ...
                                                        <div class="form-group row" hidden>
                                                            ...
                                                            <div class="col-lg-6 col-xl-7">
                                                                ...
                                                                <textarea class="summernote" id="description" name="description"><?php if (isset($bannermain->description)) echo $bannermain->description; ?></textarea>
                                                        ...
                                                        <div class="form-group row" hidden>
                                                            ...
                                                            <div class="col-lg-6 col-xl-7">
                                                                ...
                                                                <input type="text" class="form-control" name="link" value="<?php if (isset($bannermain->link)) echo $bannermain->link ?>">
