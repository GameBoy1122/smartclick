                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="kt-radio-inline">
                                                            ...
                                                            <label class="kt-radio kt-radio--bold kt-radio--success">
                                                                ...
                                                                <input type="radio" name="status" value="ACTIVATE" <?php if (!isset($Knowledge->status) || $Knowledge->status == "ACTIVATE") echo "checked" ?>> Activate
                                                            ...
                                                            <label class="kt-radio kt-radio--bold kt-radio--warning">
                                                                ...
                                                                <input type="radio" name="status" value="SUSPEND" <?php if (isset($Knowledge->status) && $Knowledge->status != "ACTIVATE") echo "checked" ?>> Suspend
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar1">
                                                                            ...
                                                                            if (isset($Knowledge->image) && $Knowledge->image != "" && file_exists(FCPATH . $Knowledge->image)) {

                                                                                $image = base_url('' . $Knowledge->image);
                                                                            }

                                                                            ?>

                                                                            <div class="kt-avatar__holder" <?php if (isset($Knowledge->image)) echo ' style="background-image:url(' . $image . ');"'; ?>> </div>
                                                                    ...
                                                                    <div class="tab-content" id="nav-tabContent">
                                                                        <div class="tab-pane fade show active mt-5" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <input type="text" class="form-control" name="title_th" value="<?php if (isset($Knowledge->title_th)) echo $Knowledge->title_th ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="description_th" name="description_th"><?php if (isset($Knowledge->description_th)) echo $Knowledge->description_th; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="tab-pane fade mt-5" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <input type="text" class="form-control" name="title_en" value="<?php if (isset($Knowledge->title_en)) echo $Knowledge->title_en ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Short Description EN</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="short_description_en" name="short_description_en"><?php if (isset($Knowledge->short_description_en)) echo $Knowledge->short_description_en; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Description EN</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="description_en" name="description_en"><?php if (isset($Knowledge->description_en)) echo $Knowledge->description_en; ?></textarea>
                                                                                </div>
                                                                            </div>
