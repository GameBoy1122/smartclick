...
<head>
    ...
    <link href="<?php echo assetsDirectory("dist/assets/css/pages/login/login-4.css") ?>" rel="stylesheet"
        type="text/css" />
    ...
    <link href="<?php echo assetsDirectory("dist/assets/plugins/global/plugins.bundle.css") ?>" rel="stylesheet"
        type="text/css" />
    ...
    <link href="<?php echo assetsDirectory("dist/assets/css/skins/header/base/light.css") ?>" rel="stylesheet"
        type="text/css" />

    <link href="<?php echo assetsDirectory("dist/assets/css/skins/header/menu/light.css") ?>" rel="stylesheet"
        type="text/css" />

    <link href="<?php echo assetsDirectory("dist/assets/css/skins/brand/dark.css") ?>" rel="stylesheet"
        type="text/css" />

    <link href="<?php echo assetsDirectory("dist/assets/css/skins/aside/dark.css") ?>" rel="stylesheet"
        type="text/css" />

    <!-- PAGE WIZARD -->

    <link href="<?php echo assetsDirectory("dist/assets/css/pages/wizard/wizard-3.css") ?>" rel="stylesheet"
        type="text/css" />
                            ...
                            <div class="kt-portlet__head kt-iconbox kt-iconbox--brand kt-iconbox--animate-slow">
                                ...
                                <div class="kt-portlet__head-label">
                                    ...
                                    <span class="kt-portlet__head-icon">
                                        ...
                                        <i
                                            class="kt-font-brand <?php echo $configurations["PORTLET_HEADER"]["ICON"] ?>"></i>
                                    ...
                                    <div class="kt-grid kt-wizard-v3 kt-wizard-v3--white" id="kt_wizard_v3"
                                        ...
                                        <form class="kt-form form_data" id="main-form">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-lg-3 col-form-label" align="right">STATUS <span
                                                    ...
                                                    <div class="kt-radio-inline">
                                                        ...
                                                        <label class="kt-radio kt-radio--bold kt-radio--success">
                                                            ...
                                                            <input type="radio" name="status" value="ACTIVATE"
                                                                <?php if (!isset($Landingpage->status) || $Landingpage->status == "ACTIVATE") echo "checked" ?>>
                                                            Activate
                                                ...
                                                <div class="kt-form__section kt-form__section--first">
                                                    ...
                                                    <div class="kt-wizard-v3__form">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <label class="col-xl-3 col-lg-3 col-form-label"
                                                                        align="right">BANNER </label>

                                                                    <div class="kt-avatar kt-avatar--outline"
                                                                        id="kt_user_add_avatar1">

                                                                        <?php

                                                                        $image = '';

                                                                        if (isset($Landingpage->image) && $Landingpage->image != "" && file_exists(FCPATH . $Landingpage->image)) {

                                                                            $image = base_url($Landingpage->image);
                                                                        }

                                                                        ?>

                                                                        <div class="kt-avatar__holder"
                                                                            <?php if (isset($Landingpage->image)) echo ' style="background-image:url(' . $image . ');"'; ?>>
                                                                        </div>
                                                        ...
                                                        <div class="form-group row d-none">
                                                            ...
                                                            <label class="col-lg-3 col-form-label" align="right">Title
                                                                TH</label>

                                                            <div class="col-lg-6 col-xl-7">

                                                                <input type="text" class="form-control" name="title_th"
                                                                    value="<?php if (isset($Landingpage->title_th)) echo $Landingpage->title_th ?>">
                                                        ...
                                                        <div class="form-group row d-none">
                                                            ...
                                                            <div class="col-lg-6 col-xl-7">
                                                                ...
                                                                <input type="text" class="form-control" name="title_en"
                                                                    value="<?php if (isset($Landingpage->title_en)) echo $Landingpage->title_en ?>">
                                                        ...
                                                        <div class="form-group row d-none">
                                                            ...
                                                            <label class="col-lg-3 col-form-label"
                                                                align="right">Description TH</label>

                                                            <div class="col-lg-6 col-xl-7">

                                                                <textarea class="summernote" id="description_th"
                                                                    name="description_th"><?php if (isset($Landingpage->description_th)) echo $Landingpage->description_th; ?></textarea>
                                                        ...
                                                        <div class="form-group row d-none">
                                                            ...
                                                            <label class="col-lg-3 col-form-label"
                                                                align="right">Description EN</label>

                                                            <div class="col-lg-6 col-xl-7">

                                                                <textarea class="summernote" id="description_en"
                                                                    name="description_en"><?php if (isset($Landingpage->description_en)) echo $Landingpage->description_en; ?></textarea>
                                                        ...
                                                        <div class="form-group row d-none">
                                                            ...
                                                            <label class="col-lg-3 col-form-label" align="right">View
                                                                more ( Link )</label>

                                                            <div class="col-lg-6 col-xl-7">

                                                                <input type="text" class="form-control" name="link"
                                                                    value="<?php if (isset($Landingpage->link)) echo $Landingpage->link ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            ...
                                            <button type="button" class="btn btn-outline-danger mr-2"
                                                id="kt_sweetalert_cancel">Cancel</button>
...
<script src="<?php echo assetsDirectory("dist/assets/plugins/global/plugins.bundle.js") ?>" type="text/javascript">
</script>
...
<script src="<?php echo assetsDirectory("dist/assets/js/pages/custom/login/login-general.js") ?>"
    type="text/javascript"></script>

<script src="<?php echo assetsDirectory("dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js") ?>"
    type="text/javascript"></script>

<script src="<?php echo assetsDirectory("dist/assets/js/pages/components/extended/sweetalert2.js") ?>"
    type="text/javascript"></script>
...
<script src="<?php echo assetsDirectory("dist/assets/plugins/bootstrap-fileinput/bootstrap-fileinput.js"); ?>"
    type="text/javascript"></script>
                    ...
                    success: function(response) {
                        ...
                        try {
                            ...
                            if (response.code == "0x0000-00000") {
                                ...
                                $("#system-return-error .message").html(response
                                    .message);
                                ...
                                swal.fire({
                                    ...
                                    html: response.message +
                                        '<br><br> Please check your process',
