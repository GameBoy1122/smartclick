...
<head>
    ...
    <link href="<?php echo assetsDirectory("dist/assets/plugins/custom/datatables/datatables.bundle.css") ?>"
                            ...
                            <div class="kt-portlet__head  kt-iconbox kt-iconbox--brand kt-iconbox--animate-slow">
                                ...
                                <div class="kt-portlet__head-toolbar">
                                    ...
                                    <div class="kt-portlet__head-wrapper">
                                        ...
                                        <a href="<?php echo base_url('AdministratorArea/landingpage/edit'); ?>">
...
<script src="<?php echo assetsDirectory("dist/assets/plugins/custom/datatables/datatables.bundle.js") ?>"
    type="text/javascript"></script>



<script src="<?php echo assetsDirectory("dist/assets/js/pages/crud/datatables/extensions/rowreorder.js") ?>"
    type="text/javascript"></script>
    ...
    var demo = function() {
        ...
        var datatable = $('.kt-datatable').KTDatatable({
            ...
            data: {
                ...
                source: '<?php echo base_url('AdministratorArea/landingpage/datatables'); ?>',
            ...
            columns: [
...

                {
                    ...
                    template: function(row) {
                        ...
                        var db_id = row['landingpage_id'];

                        var action_header =
                            '<a href="<?php echo base_url('AdministratorArea/landingpage/edit/'); ?>' +
                            db_id +
                            '"class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Edit details">' +
                        ...
                        action_header +=
                            '<a class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Delete" id="confirmDelete' +
                            db_id + '">' +
                            ...
                            '" value="<?php echo base_url('AdministratorArea/landingpage/delete/'); ?>' +
                            db_id + '">';
