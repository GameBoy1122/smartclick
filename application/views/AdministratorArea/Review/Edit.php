                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="kt-radio-inline">
                                                            ...
                                                            <label class="kt-radio kt-radio--bold kt-radio--success">
                                                                ...
                                                                <input type="radio" name="status" value="ACTIVATE" <?php if (!isset($Review->status) || $Review->status == "ACTIVATE") echo "checked" ?>> Activate
                                                            ...
                                                            <label class="kt-radio kt-radio--bold kt-radio--warning">
                                                                ...
                                                                <input type="radio" name="status" value="SUSPEND" <?php if (isset($Review->status) && $Review->status != "ACTIVATE") echo "checked" ?>> Suspend
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar1">
                                                                            ...
                                                                            if (isset($Review->image) && $Review->image != "" && file_exists(FCPATH . $Review->image)) {
                                                                            ...
                                                                            <div class="kt-avatar__holder" <?php if (isset($Review->image)) echo ' style="background-image:url(' . $image . ');"'; ?>> </div>
                                                                ...
                                                                <div class="col-12">
                                                                    ...
                                                                    <div class="tab-content" id="nav-tabContent">
                                                                        <div class="tab-pane fade show active mt-5" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Name TH</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <input type="text" class="form-control" name="name_th" value="<?php if (isset($Review->name_th)) echo $Review->name_th ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Description TH</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="description_th" name="description_th"><?php if (isset($Review->description_th)) echo $Review->description_th; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Review TH</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="review_th" name="review_th"><?php if (isset($Review->review_th)) echo $Review->review_th; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="tab-pane fade mt-5" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Name EN</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <input type="text" class="form-control" name="name_en" value="<?php if (isset($Review->name_en)) echo $Review->name_en ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Description EN</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="description_en" name="description_en"><?php if (isset($Review->description_en)) echo $Review->description_en; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Review EN</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="review_en" name="review_en"><?php if (isset($Review->review_en)) echo $Review->review_en; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="tab-pane fade mt-5" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Name AE</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <input type="text" class="form-control" name="name_ae" value="<?php if (isset($Review->name_ae)) echo $Review->name_ae ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Description AE</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="description_ae" name="description_ae"><?php if (isset($Review->description_ae)) echo $Review->description_ae; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Review AE</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="review_ae" name="review_ae"><?php if (isset($Review->review_ae)) echo $Review->review_ae; ?></textarea>
                                                                                </div>
                                                                            </div>
