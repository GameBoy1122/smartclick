                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="kt-radio-inline">
                                                            ...
                                                            <label class="kt-radio kt-radio--bold kt-radio--success">
                                                                ...
                                                                <input type="radio" name="status" value="ACTIVATE" <?php if (!isset($Solution->status) || $Solution->status == "ACTIVATE") echo "checked" ?>> Activate
                                                            ...
                                                            <label class="kt-radio kt-radio--bold kt-radio--warning">
                                                                ...
                                                                <input type="radio" name="status" value="SUSPEND" <?php if (isset($Solution->status) && $Solution->status != "ACTIVATE") echo "checked" ?>> Suspend
                                                ...
                                                <div class="kt-wizard-v3__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
                                                    ...
                                                    <div class="kt-form__section kt-form__section--first">
                                                        ...
                                                        <div class="kt-wizard-v3__form">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <label class="col-xl-3 col-lg-3 col-form-label" align="right">ICON</label>
                                                                        ...
                                                                        <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar1">
                                                                            ...
                                                                            if (isset($Solution->icon) && $Solution->icon != "" && file_exists(FCPATH . $Solution->icon)) {

                                                                                $icon = base_url('' . $Solution->icon);
                                                                            }

                                                                            ?>

                                                                            <div class="kt-avatar__holder" <?php if (isset($Solution->icon)) echo ' style="background-image:url(' . $icon . ');"'; ?>> </div>

                                                                            <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="Change Banner">

                                                                                <i class="fa fa-pen"></i>

                                                                                <input type="file" name="icon[th]">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <label class="col-xl-3 col-lg-3 col-form-label" align="right">THUBNAIL</label>
                                                                        ...
                                                                        <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar2">
                                                                            ...
                                                                            if (isset($Solution->image) && $Solution->image != "" && file_exists(FCPATH . $Solution->image)) {

                                                                                $image = base_url('' . $Solution->image);
                                                                            }
                                                                            ?>

                                                                            <div class="kt-avatar__holder" <?php if (isset($Solution->image)) echo ' style="background-image:url(' . $image . ');"'; ?>> </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-lg-3 col-form-label" align="right">Category<?php if ($Solution->solution_category_id == '') {
                                                                                                                                    echo "checked";
                                                                                                                                } ?></label>
                                                                <div class="col-lg-6 col-xl-7">
                                                                    <select class="form-select" name="Category" id="Category">

                                                                        <option value="1" <?php if ($Solution->solution_category_id == 1) {
                                                                                                echo "selected";
                                                                                            } ?>>Enterprise Application</option>
                                                                        <option value="2" <?php if ($Solution->solution_category_id == 2) {
                                                                                                echo "selected";
                                                                                            } ?>>Data Center and Cloud</option>
                                                                        <option value="3" <?php if ($Solution->solution_category_id == 3) {
                                                                                                echo "selected";
                                                                                            } ?>>Digital Marketing</option>
                                                                        <option value="4" <?php if ($Solution->solution_category_id == 4) {
                                                                                                echo "selected";
                                                                                            } ?>>Streaming Solution</option>
                                                                        <option value="5" <?php if ($Solution->solution_category_id == 5) {
                                                                                                echo "selected";
                                                                                            } ?>>IT Suppor</option>
                                                                    ...
                                                                    <div class="tab-content" id="nav-tabContent">
                                                                        <div class="tab-pane fade show active mt-5" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <input type="text" class="form-control" name="title_th" value="<?php if (isset($Solution->title_th)) echo $Solution->title_th ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Short Description TH</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="short_description_th" name="short_description_th"><?php if (isset($Solution->short_description_th)) echo $Solution->short_description_th; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="description_th" name="description_th"><?php if (isset($Solution->description_th)) echo $Solution->description_th; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="tab-pane fade mt-5" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <input type="text" class="form-control" name="title_en" value="<?php if (isset($Solution->title_en)) echo $Solution->title_en ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Short Description EN</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="short_description_en" name="short_description_en"><?php if (isset($Solution->short_description_en)) echo $Solution->short_description_en; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Description EN</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="description_en" name="description_en"><?php if (isset($Solution->description_en)) echo $Solution->description_en; ?></textarea>
                                                                                </div>
                                                                            </div>
