                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="kt-radio-inline">
                                                            ...
                                                            <label class="kt-radio kt-radio--bold kt-radio--success">
                                                                ...
                                                                <input type="radio" name="status" value="ACTIVATE" <?php if (!isset($Solution_category->status) || $Solution_category->status == "ACTIVATE") echo "checked" ?>> Activate
                                                            ...
                                                            <label class="kt-radio kt-radio--bold kt-radio--warning">
                                                                ...
                                                                <input type="radio" name="status" value="SUSPEND" <?php if (isset($Solution_category->status) && $Solution_category->status != "ACTIVATE") echo "checked" ?>> Suspend
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar1">
                                                                            ...
                                                                            if (isset($Solution_category->image) && $Solution_category->image != "" && file_exists(FCPATH . $Solution_category->image)) {

                                                                                $image = base_url('' . $Solution_category->image);
                                                                            }

                                                                            ?>

                                                                            <div class="kt-avatar__holder" <?php if (isset($Solution_category->image)) echo ' style="background-image:url(' . $image . ');"'; ?>> </div>
                                                                    ...
                                                                    <div class="tab-content" id="nav-tabContent">
                                                                        <div class="tab-pane fade show active mt-5" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <input type="text" class="form-control" name="title_th" value="<?php if (isset($Solution_category->title_th)) echo $Solution_category->title_th ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Short Description TH</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="short_description_th" name="short_description_th"><?php if (isset($Solution_category->short_description_th)) echo $Solution_category->short_description_th; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="description_th" name="description_th"><?php if (isset($Solution_category->description_th)) echo $Solution_category->description_th; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="tab-pane fade mt-5" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <input type="text" class="form-control" name="title_en" value="<?php if (isset($Solution_category->title_en)) echo $Solution_category->title_en ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Short Description EN</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="short_description_en" name="short_description_en"><?php if (isset($Solution_category->short_description_en)) echo $Solution_category->short_description_en; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label" align="right">Description EN</label>
                                                                                <div class="col-lg-6 col-xl-7">
                                                                                    <textarea class="summernote" id="description_en" name="description_en"><?php if (isset($Solution_category->description_en)) echo $Solution_category->description_en; ?></textarea>
                                                                                </div>
                                                                            </div>
