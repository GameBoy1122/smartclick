                                ...
                                ?>
                                    ...
                                    <div class="kt-portlet__head-toolbar">
                                        ...
                                        <div class="kt-portlet__head-wrapper">
                                            ...
                                            <a href="<?php echo base_url('AdministratorArea/Treatment/edit'); ?>">
        ...
        var demo = function() {
            ...
            var datatable = $('.kt-datatable').KTDatatable({
                ...
                data: {
                    ...
                    source: '<?php echo base_url('AdministratorArea/Treatment/datatables'); ?>',
                ...
                columns: [
...

                    {
                        ...
                        template: function(row) {
                            ...
                            var action_header = '<a href="<?php echo base_url('AdministratorArea/Treatment/edit/'); ?>' + db_id + '"class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Edit details">' +
                            ...
                            action_header += '<a class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Delete" id="confirmDelete' + db_id + '">' +
                                ...
                                '<input type="hidden" id="' + db_id + '" value="<?php echo base_url('AdministratorArea/Treatment/delete/'); ?>' + db_id + '">';
