                ...
                <tr>
                    <td class="email-masthead">
                        <table style="margin: 0 auto;">
                            <tr>
                                <td>
                                    <img alt="" class="img-circle" src="<?php echo assets_template_1($this->config->item('WEBSITE_LOGO'));?>" style="max-width: 200px;max-height: 60px;">
                                </td>
                                <td>
                                    ...
                                    <table class="body-action" align="center" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center">
                                                <div>
                                                    <!--[if mso]>
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://www.google.co.th" style="height:45px;v-text-anchor:middle;width:200px;" arcsize="7%" stroke="f" fill="t">
                                    ...
                                    <table class="body-sub">
                                        <tr>
                                            <td>
                                                ...
                                                <p class="sub"><a href="<?php echo $url;?>" style="word-break: break-all;">http://www.google.co.th</a></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
